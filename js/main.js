...
const eigenServer = L.tileLayer.wms('http://localhost:8001/geoserver/hsfm/wms', {
    'layers': 'hsfm:gemeente_2019_v1',
    'srs': 'EPSG:28992',
    'format': 'image/png',
    'opacity': '0.6',
    'transparent': true,
...
if(!toggle) {
    RDNewMap.removeLayer(eigenServer);
} else {
    RDNewMap.addLayer(eigenServer);
}
toggle = !toggle;
}
...
const maplibre = new maplibregl.Map({
    ...
    center: [-0.13994767,51.51289135], // starting position [lng, lat]
...
type: 'bar',
data: {
labels: ['To read', 'Read', 'Reading', 'Unfinished', 'Unworthy'],
datasets: [{
label: '# of books',
data: [12, 19, 3, 5, 2, 3],
backgroundColor: [
